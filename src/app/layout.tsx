...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: "Reservá tu turno con Carla Bruni · dermocosmetóloga y esteticista · Espacio Freyja",
    icons: {
      icon: [
    ...
    openGraph: {
      ...
      description: "Dermocosmetología y estética · Espacio Freyja",
      images: [
        {
          url: ogImageAbsolute,
          ...
          width: 1200,
          height: 630,
          alt: "Carla Bruni · Espacio Freyja",
          type: "image/jpeg",
        },
      ],
    },
...
export default function RootLayout({
  ...
  return (
    <html lang="es">
      ...
      <body
        className={`${montserrat.variable} ${playfair.variable} min-h-screen bg-[var(--background)] text-white antialiased`}
      >
        <GoogleAnalytics />
        {children}
      </body>
