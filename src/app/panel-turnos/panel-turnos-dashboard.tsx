...
function ServiceIcon({ category }: { category: string }) {
  ...
  if (category === "Freyja · Low Cost") return <Sparkles className={cls} strokeWidth={1.85} />;
  if (category === "Freyja · Premium") return <Gem className={cls} strokeWidth={1.85} />;
  if (category === "Alta energía") return <Zap className={cls} strokeWidth={1.85} />;
  if (category === "Corporal") return <ScanLine className={cls} strokeWidth={1.85} />;
  if (category === "Láser") return <CircleDot className={cls} strokeWidth={1.85} />;
